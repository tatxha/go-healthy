<?php
    ...
    if (isset($_POST['btn-add'])) {
        ...
        $isAddSucceed = add_penyakit($_POST, $_FILES);
        if ($isAddSucceed > 0) {
          ...
          <h2>Tambah Data Penyakit</h2>
                  ...
                  <div class="container" data-aos="fade-up" style="width: fit-content;">
                    ...
                    <div class="gradient-custom-1 h-100">
                        ...
                        <div class="container">
                            <form action="tambah_penyakit.php" method="POST" id="form-add" enctype="multipart/form-data">
                                ...
                                <div class="mb-3"> <!-- KETERANGAN SINGKAT PENYAKIT -->
                                    ...
                                    <input type="text" class="form-control" id="ket_penyakit" name="ket_penyakit">
                                </div>
                                <div class="mb-3"> <!-- RESIKO KEMATIAN -->
                                    <label for="resiko_kematian" class="form-label">Resiko Kematian</label>
                                    <input type="text" class="form-control" id="resiko_kematian" name="resiko_kematian" required>
                                </div>
                                <div class="mb-3"> <!-- LINK INFORMASI TENTANG PENYAKIT -->
                                    <label for="link_penyakit" class="form-label">Link Informasi Penyakit</label>
                                    <input type="url" class="form-control" id="link_penyakit" name="link_penyakit" required>
                                </div><br>
                                
                                <a href="data_penyakit.php"><button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button></a>
                                <button type="submit" class="btn btn-info text-white" style="background-color: #3B6E8D" name="btn-add" id="btn-add" form="form-add">Tambahkan Data Penyakit</button>
                            </form>
