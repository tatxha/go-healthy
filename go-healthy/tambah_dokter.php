<?php
    ...
    if (isset($_POST['btn-add'])) {
        ...
        $isAddSucceed = add_dokter($_POST, $_FILES);
        if ($isAddSucceed > 0) {
                    ...
                    <div class="gradient-custom-1 h-100">
                        ...
                        <div class="container">
                            <form action="tambah_dokter.php" method="POST" id="form-add" enctype="multipart/form-data">
                                ...
                                <button type="submit" class="btn btn-info text-white" style="background-color: #3B6E8D" name="btn-add" id="btn-add" form="form-add">Tambahkan Data Dokter</button>
                            </form>
