<?php
include "config.php";
$sql = mysqli_query($conn, "SELECT * FROM t_nutrisi_makanan
JOIN t_jenis_sumber_nutrisi ON t_jenis_sumber_nutrisi.id_jenis_nutrisi = t_nutrisi_makanan.id_jenis_nutrisi WHERE id_nutrisi = '$_GET[kode_update]'");
