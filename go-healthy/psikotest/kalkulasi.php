...
if (isset($_POST['submit'])) {
    ...
    if ($hasil>=10 && $hasil<=15) {
        echo "<script>
            ...
            window.location = 'tidak_stress.html';
        </script>";
    }
    ...
    elseif ($hasil>=16 && $hasil<=25) {
        echo "<script>
        alert('Yuk Liat Hasilnya !');
        window.location = 'stress_ringan.html';
    </script>";
    }
    ...
    elseif ($hasil>=26 && $hasil<=35) {
        echo "<script>
        alert('Yuk Liat Hasilnya !');
        window.location = 'stress_sedang.html';
    </script>";
    }
    ...
    elseif ($hasil>=36 && $hasil<=45) {
        echo "<script>
        alert('Yuk Liat Hasilnya !');
        window.location = 'stress_tinggi.html';
    </script>";
    }    
    ...
    elseif ($hasil>=46 && $hasil<=50) {
        echo "<script>
        alert('Yuk Liat Hasilnya !');
        window.location = 'stress_parah.html';
    </script>";
    }
}
else{
