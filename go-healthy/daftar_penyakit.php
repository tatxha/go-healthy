                                ...
                                <div class="col-12">
                                    ...
                                    <table class="table mb-0 table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <th scope="col">Resiko Kematian</th>
                                        ...
                                        <?php
                                          foreach($list_penyakit as $v_penyakit)
                                          {
                                        ?>
                                        <tbody>
                                          <tr>
                                            <td><?=$v_penyakit['nama_penyakit']?></td>
                                            <td><?=$v_penyakit['ket_penyakit']?></td>
                                            <td><?=$v_penyakit['resiko_kematian']?>%</td>
                                            <td><a href="<?=$v_penyakit['link_penyakit']?>">baca selengkapnya...</a></td>
                                            </tr>
                                        </tbody>
                                        <?php
                                          }
