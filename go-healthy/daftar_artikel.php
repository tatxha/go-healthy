    ...
    <section id="doctors" class="doctors">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Artikel</h2>
          <p>Perhatikan kesehatanmu, tetap jaga kesehatan dan mencari tau lebih banyak akan kesehatan Anda.</p>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            <div class="member d-flex align-items-start">
              <div>
                <img src="assets/img/articles/<?=$t_artikel['foto_artikel']?>" class="modified-test">
              </div>
              <div class="member-info">
                <h4><?=$t_artikel['judul_artikel']?></h4>
                <span><?=$t_artikel['nama_jenis_artikel']?></span>
                <span><?=$t_artikel['ket_singkat']?></span>
                <p><a href="isi_artikel.php?id_artikel=<?=$t_artikel['id_artikel']?>">...baca selengkapnya</a></p>
              </div>
            </div>
            <div class="br">
            <br>
