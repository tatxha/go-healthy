    ...
    <section id="kendala" class="appointment section-bg">
      <div class="container">
        ...
        <div class="section-title">
          <?php
            ?>
          <h2><?=$t_artikel['judul_artikel']?></h2>
          <p><?=$t_artikel['ket_singkat']?>.</p>
          <br>
          <img src="assets/img/articles/<?=$t_artikel['foto_artikel']?>" style="width: 60%"><br>
          
          <!-- <div class="waduh"> -->
            
              <br><br><p><?=$t_artikel['isi_artikel']?></p>
          <!-- </div> -->
