    ...
    <section id="faq" class="faq section-bg">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Admin Page</h2>
          <p>Halo para Admin, selamat datang di Admin Page, mohon difungsikan dengan benar</p>
        </div>

        <div class="faq-list">
            <ul>
                <li class="nav-item ">
                  <a class="nav-link"  href="data_kendala.php">
                    <h4 class='text-center'>Data Kendala</h4>
                  </a>
                </li><!-- End tab nav item -->
                ...
                <li class="nav-item">
                  <a class="nav-link" href="data_penyakit.php">
                    <h4 class='text-center'>Data Penyakit</h4>
                  </a>
                </li><!-- End tab nav item -->
                
                <li class="nav-item">
                  <a class="nav-link" href="data_nutrisi.php">
                    <h4 class='text-center'>Data Nutrisi Makanan</h4>
                  </a>
                </li><!-- End tab nav item -->
                
                <li class="nav-item">
                  <a class="nav-link" href="data_artikel.php">
                    <h4 class='text-center'>Data Artikel</h4>
                  </a>
                </li><!-- End tab nav item -->
